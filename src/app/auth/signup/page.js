export const metadata = {
  title: "Sign Up | BidAgri",
  description:
    "Create a BidAgri account to connect with agricultural partners, manage listings, and grow your network.",
};
      ...
      <section className="pt-24">
        <div className="w-full px-4 md:px-8 max-w-6xl mx-auto text-center py-12 md:py-16">
          ...
          <p className="mt-4 text-sm md:text-base text-gray-600 max-w-2xl mx-auto">
            Sign up to start listing produce, receiving bids, and building direct relationships across the supply chain.
          </p>
        </div>
      </section>
